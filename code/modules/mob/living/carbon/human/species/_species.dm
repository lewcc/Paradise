/datum/species
	...
	var/list/male_laugh_sounds = list("sound/effects/mob_effects/manlaugh1.ogg", "sound/effects/mob_effects/manlaugh2.ogg")
	var/list/female_laugh_sounds = list("sound/effects/mob_effects/womanlaugh.ogg")
